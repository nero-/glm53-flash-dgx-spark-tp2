...
| Image | `local/vllm:glm53-flash-nvfp4-head0906-managed`, built with the arm64/SM121 retarget of `blackwell-llm-docker` (CUDA 13.2 / torch 2.13.0+cu132); previous line `…-devspark` kept as rollback |
